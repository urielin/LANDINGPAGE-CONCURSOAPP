...
<?php
  ...
  function email_message ($replStr) {
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" class="imageContent">
                                    <img src="http://munitacna.gob.pe/desafiomovil2018/images/apps.jpg" width="500" class="flexibleImage" style="max-width:500px;width:100%;display:block;" alt="Text" title="Text" />
                                  </td>
                                </tr>
                              </table>
                              <!-- // CONTENT TABLE -->
                                                    ...
                                                    <tr>
                                                      <td align="left" class="textContent">
                                                        ...
                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                          Pellentesque habitant morbi tristique</div>
                                                      </td>
                                                    </tr>
                                                  </table>
                                                </td>
