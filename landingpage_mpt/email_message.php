...
<?php
  ...
  function email_message ($nombres,$apellidos,$nombreapp)
{
              ...
              <td align="center" valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td align="center" valign="top">
                      <!-- FLEXIBLE CONTAINER // -->
                      <table border="0" cellpadding="0" cellspacing="0" class="flexibleContainer" style="width:  100%;">
                        <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="imageContent">
                                  ...
                                  <tbody><tr>
                                  	<td valign="center" bgcolor="#85324e"><img src="http://munitacna.gob.pe/desafiomovil2018/images/escudotacna.png" height="90px"></td>
                                  	<td bgcolor="#85324e" width="85%" align="left" valign="center"><b><font color="#FFFFFF">Municipalidad Provincial de Tacna</font></b></td>
                                  	<td valing="center" bgcolor="#85324e" align="right"><img src="http://munitacna.gob.pe/desafiomovil2018/images/logo2.png"></td>
                                  </tr>
                                  </tbody></table>
                                                  ...
                                                  <tr>
                                                    <td valign="top" class="textContent">
                                                      <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                                        REGISTRO EN DESAFIO MOVIL 2018</h3>
                                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                        Se ha registrado el aplicativo
                                            ...
                                            <tr>
                                              <td align="left" valign="top" class="textContent">
                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                    El presente documento certifca la inscripci�n correcta en el concurso Desafio M�vil 2018. Y que la informaci�n consignada en el registro web es v�lida.
                                                    <br>
                                                    <br>
                                                    Adem�s el proyecto estar� representado por:
                                                </div>
                                              </td>
                                            </tr>
                                          </table>
                                            ...
                                            <tr>
                                              <td align="left" valign="top" class="flexibleContainerBox">
                                                <table border="0" cellpadding="0" cellspacing="0" width="90" style="max-width:100%;">
                                                  <tr>
                                                    <td align="left" class="textContent">
                                                      <img src="http://munitacna.gob.pe/desafiomovil2018/images/desarrollo-apps-mallorca2.jpg" width="73" class="flexibleImageSmall" style="max-width:100%;" alt="Text" title="Text" />
                                                    </td>
                                                  </tr>
                                                </table>
                                              </td>
                                                  ...
                                                  <tr>
                                                    <td align="left" class="textContent">
                                                      ...
                                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                        Representante del Aplicativo <?php echo strtoupper($nombreapp) ?>
                            ...
                            <td align="center" valign="top">
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                  <td align="center" valign="top">
                                    <!-- FLEXIBLE CONTAINER // -->
                                    <table style="margin-top: 30px;" width="500" class="flexibleContainer">
                                      <tr>
                                        <td valign="top" width="500" class="flexibleContainerCell">
                                                  ...
                                                  <tr>
                                                    <td valign="top" class="textContent">
                                                      <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                        Para confirmar el registro de su aplicativo m�vil deber� imprimirse y presentarse
                                                        en la Sub Gerencia de Tecnolog��as de Informaci�n y Comunicaciones de la Municipalidad Provincial de Tacna</div>
                                                    </td>
                                                  </tr>
                                                </table>
                                                <!-- // CONTENT TABLE -->
                                ...
                                <td valign="top" bgcolor="#E1E1E1">
                                  ...
                                  <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                    <div>�Copyright DesafioApp <a href="http://munitacna.gob.pe/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">
                                       Sub Gerencia de Tecnolog��as de Informaci�n y Comunicaciones</span></a>.</div>
                                  </div>
