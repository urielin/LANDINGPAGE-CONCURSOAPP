...
<html lang="es">
                      ...
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          ...
                          <div class="text-center">
                              <h2 class="wow fadeInLeft animated animated" style="visibility: visible; animation-name: fadeInLeft;">INSCRÍBETE AL CONCURSO DE APLICACIONES MÓVILES</h2>
              ...
              <div class="container">
                  <div class="row">
                      ...
                      <div class="col-md-6 wow slideInRight animated" style="visibility: visible; animation-name: slideInRight;">
                          ...
                          <div class="btn-section"><a href="https://drive.google.com/file/d/1YOTH3d8WvHZDlvt0iQL29SGANy17ppKn/view?usp=sharing" target="_blank" class="btn-default">Leer Más</a></div>
  ...
  <!--                         <div style="text-align: center;">
                          ...
                          <!-- <div class="col-sm-6 feat-list">
                              <div></div>
                              <div class="inner">
                                  <a href="https://drive.google.com/open?id=1bQNAOXMS20Bk3X37oIYCUbu5SgKuuJ0T"  target="_blank" class="btn-default">Leer Más</a>
                              </div>
                          </div> -->
                      </div>
                  </div>
